...
class RiotAccount
{
     ...
     * @ORM\OneToMany(targetEntity="App\Entity\LeagueOfLegends\SummonerName", mappedBy="owner")
     ...
     * @ORM\OneToMany(targetEntity="App\Entity\LeagueOfLegends\Ranking", mappedBy="owner")
     * @ORM\OrderBy({"createdAt"="DESC"})
     */
    protected $rankings;
