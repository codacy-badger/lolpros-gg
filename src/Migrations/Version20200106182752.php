...
final class Version20200106182752 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE profile__staff (id INT AUTO_INCREMENT NOT NULL, profile_id INT DEFAULT NULL, position VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        //UNIQUE INDEX UNIQ_A07C7869CCFA12B8 (profile_id),
        ...
        $this->addSql('INSERT INTO profile__staff (profile_id, position) SELECT profile_id, "10_coach" FROM team__members WHERE team__members.role="staff"');
