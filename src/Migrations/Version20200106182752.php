...
final class Version20200106182752 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE league__player (id INT AUTO_INCREMENT NOT NULL, profile_id INT DEFAULT NULL, position VARCHAR(255) NOT NULL, score INT DEFAULT 0 NOT NULL, UNIQUE INDEX UNIQ_D8838497CCFA12B8 (profile_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE profile__staff (id INT AUTO_INCREMENT NOT NULL, profile_id INT DEFAULT NULL, position VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_A07C7869CCFA12B8 (profile_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
